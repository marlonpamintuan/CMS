...
<head>
  ...
  <title>CMS | Under Hydro Testing</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Hydro Test Report</li>
      </ol>
    </section>
    ...
    <div class="modal-content">
      ...
      <div class="form-group">
                <label>Select Container Number</label>
                  <?php $query = "select DISTINCT(CYLINDER_ID) from hydro";
      ...
      <div class="row">
        ...
        <tr>
           ...
           <th style="width:15%;" class="bg-primary">FIXED HOW MANY TIMES</th>
                ...
                <tbody>
                        <?php
$query = "select *,count(*) as count from hydro GROUP BY CYLINDER_ID";
