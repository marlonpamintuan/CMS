...
$query = "select * from hydro WHERE HYDRO_DATEONLY >= '$FROM' and HYDRO_DATEONLY <= '$TO'";
$result = mysqli_query($link,$query);
$total = mysqli_query($link,"select Count(*) as total_full from hydro WHERE HYDRO_DATEONLY >= '$FROM' and HYDRO_DATEONLY <= '$TO'");
...
function myFunction() {
    ...
    window.print();
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Hydro Test History</li>
      </ol>
    </section>
...
<h4 class="font" style="font-size:15px;">U N D E R&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; H Y D R O T E S T &nbsp;&nbsp;&nbsp;&nbsp;  C O N T A I N E R S</h4>
...
$HYDRO_DATEONLY = $row['HYDRO_DATEONLY'];
...
<td class="font" style="border:none!important;"><?php echo $HYDRO_DATEONLY;?></td>
</tr>
