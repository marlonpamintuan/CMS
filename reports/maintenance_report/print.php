...
$query = "select * from trash WHERE TRASH_DATEONLY >= '$FROM' and TRASH_DATEONLY <= '$TO'";
$result = mysqli_query($link,$query);
$total = mysqli_query($link,"select Count(*) as total_full from trash WHERE TRASH_DATEONLY >= '$FROM' and TRASH_DATEONLY <= '$TO'");
...
<h4 class="font" style="font-size:15px;">M A I N T E N A N C E &nbsp;&nbsp;&nbsp;&nbsp;  C O N T A I N E R S</h4>
<h4 class="font" style="font-size:15px;">AS OF <?php echo $FROM;?> - <?php echo $TO;?></h4>
</div>
</div>
<div class="row">
<div class="col-md-12">
...
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;" >Reason</th>
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;" >Date</th>
...
$TRASH_DATEONLY = $row['TRASH_DATEONLY'];
...
<td class="font" style="border:none!important;"><?php echo $TRASH_REASON;?></td>

<td class="font" style="border:none!important;"><?php echo $TRASH_DATEONLY;?></td>
</tr>
