...
<head>
  ...
  <title>CMS | Under Maintenance</title>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span class="fa fa-edit"></span>&nbsp;Please enter the container number you want to search</h4>
      </div>
      <div class="modal-body">
      <form action="print2.php" method="POST"> 
      <div class="form-group">
                <label>Select Container Number</label>
                  <?php $query = "select DISTINCT(CYLINDER_ID) from trash";
                $result2 = mysqli_query($link,$query);
                ?>
                <select class="form-control select2"  name="CYLINDER_ID" data-placeholder="Select Container Number" style="width: 100%;" required>
                 <option label="-- Select Container Number--" ></option>
                  <?php while($row2 = mysqli_fetch_array($result2)){
             
               $CYLINDER_ID = $row2['CYLINDER_ID'];
                ?> <option value="<?php echo $CYLINDER_ID;?>"><?php echo $CYLINDER_ID;?></option><?php
                }?>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-success color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-flask text-success">&nbsp;</i>Containers Under Maintenance History </h3>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="FROM" class="form-control pull-right" id="datepicker">
                </div>
                <!-- /.input group -->
              </div>
        ...
        <tr>
           ...
           <th style="width:15%;" class="bg-primary">Fixed How Many Times</th>
                ...
                <tbody>
                        <?php
$query = "select *,count(*) as count from trash GROUP BY CYLINDER_ID";
$result = mysqli_query($link,$query);
if(mysqli_num_rows($result)>0){
while($row = mysqli_fetch_array($result)){
  //$STATUS="";
$CYLINDER_REFERENCEID = $row['CYLINDER_ID'];
$s = $row['count'];
...
<!-- SlimScroll --><script src="../../plugins/select2/select2.full.min.js"></script>
<!-- InputMask -->
<!-- date-range-picker -->
