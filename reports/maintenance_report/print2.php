...
$query = "select * from trash WHERE CYLINDER_ID ='$CYLINDER_ID'";
$result = mysqli_query($link,$query);
$total = mysqli_query($link,"select Count(*) as total_full from trash WHERE CYLINDER_ID ='$CYLINDER_ID'");
...
<h4 class="font" style="font-size:15px;">AS OF <?php echo date('m/d/Y');?></h4>
</div>
</div>
<div class="row">
<div class="col-md-12">
