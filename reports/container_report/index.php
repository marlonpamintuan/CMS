...
<head>
  ...
  <title>CMS | Container Report</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-success color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-flask text-success">&nbsp;</i>Containers' History </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="row">
            ...
            <form method="post" action="print.php">
              <div class="form-group">
                <label>Select Date</label>
                  <?php $query = "select DISTINCT CYLINDER_DATECREATED from cylinder_today ORDER BY CYLINDER_DATECREATED ASC";
                $result2 = mysqli_query($link,$query);
                ?>
                 <div class="input-group input-group-md">
                <select class="form-control select2"  name="DATECREATED" data-placeholder="Select a Customer" style="width: 100%;" required>
                 <option selected disabled >-- Select Date --</option>
                  <?php while($row2 = mysqli_fetch_array($result2)){
              $CYLINDER_DATECREATED = $row2['CYLINDER_DATECREATED'];
                ?> <option value="<?php echo $CYLINDER_DATECREATED;?>"><?php echo $CYLINDER_DATECREATED;?></option><?php
                }?>
        ...
        <th style="width:8%;" class="bg-primary"></th>
          ...
          <th class="bg-primary">NUMBER OF CONTAINERS LEFT</th>
                ...
                <tbody>
                        <?php
                        $query = "select *,count(*) as count from cylinder_today GROUP BY CYLINDER_DATECREATED";
$result = mysqli_query($link,$query);
  ;
if(mysqli_num_rows($result)>0){
while($row = mysqli_fetch_array($result)){
  $CYLINDER_DATE = $row['CYLINDER_DATECREATED'];
$s = $row['count'];
...
?>
   <tr>
    ...
    <ul class="dropdown-menu">
     ...
     <li class=""><a href="javascript:delete_id('<?php echo $CYLINDER_DATECREATED; ?>')" title="Delete Item"  style="font-weight: 700;"><span class="fa fa-trash-o"></span> Delete</a></li>
  </ul>
</div>
</td>  


<td ><?php echo $CYLINDER_DATE; ?></td>
<td><?php echo $s.' '.'Container(s)'; ?></td>
