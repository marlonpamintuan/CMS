...
$query = "select * from dr inner join customer ON dr.CUSTOMER_ID = customer.CUSTOMER_ID WHERE customer.CUSTOMER_NAME = '$CUSTOMER_NAMESEARCH' AND DR_DUE = 'Overdue' AND DR_STATUS !='inactive'";
...
<thead>
<tr>
<td class="font" style="border-color:black; border-bottom:1px solid black; " >SINCE</td>
<td class="font" style="border-color:black; border-bottom:1px solid black;">D.R. #</td>
<td class="font text-center" style="border-color:black; border-bottom:1px solid black;" >CONTAINER</td>
<td class="font text-center" style="border-color:black; border-bottom:1px solid black;">DUE</td>
<td class="font" style="border-color:black; border-bottom:1px solid black;">DAYS</td>
<td class="font" style="border-color:black; border-bottom:1px solid black;" >STATUS</td>
<td class="font" style="border-color:black; border-bottom:1px solid black;">REMARKS</td>
</tr>
</thead>
<?php
...
<div class="aaa" style="font-size: 10px;">
<hr style="border-top:1px solid black;">
<div class="row">
<div class="col-md-12 text-center">
<h4 class="font" style="font-size: 15px;">We would appreciate it if you could verify the presence of these containers in your premises and return empty containers to us in the soonest possible time to avoid penalty.<br>
...
<div class="row">
<div class="col-xs-12">
<h4 class="font" style="font-size: 15px;">Received: __________________</h4>
</div>
</div>
</div>
<div class="col-xs-6">
<div class="row">
<div class="col-xs-12">
<h4 class="font" style="font-size: 15px;">Certified Correct:</h4>
</div>
</div>
</div>
...
<div class="row">
<div class="col-xs-12">
<h4 class="font" style="font-size: 15px;">Date: _______________________</h4>
</div>
</div>
</div>
<div class="col-xs-6">
<div class="row">
<div class="col-xs-12">
<h4 class="font">________________________________</h4>
</div>
</div>
</div>
