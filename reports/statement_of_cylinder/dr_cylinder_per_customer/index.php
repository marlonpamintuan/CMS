...
<head>
  ...
  <title>CMS | Container in Customer</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success color-palette-box" style="overflow:auto;">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-flask text-success">&nbsp;</i>Statement of Containers per Customer as of <font color="red"><?php echo date("m/d/Y",strtotime('+6 hours'));;?></font></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="TRANSACTION_DATE"  class="form-control pull-right" id="datepicker" required/>
                </div>
                <!-- /.input group -->
              </div>
              </div>
            ...
            <div class="row">
                <div class="col-md-12">
            <button type="submit" class="btn btn-success pull-right"><font>Search</font></button><br>
             </div>
            </div>
             </form>
            <br>
          ...
          <th class="bg-primary">STATUS</th>
                ...
                <tbody>
                        <?php
$query = "select * from dr inner join customer ON dr.CUSTOMER_ID = customer.CUSTOMER_ID where dr.DR_STATUS =''";
...
<td><?php echo $DUE; ?></td>
<td><?php echo $DR_DAYS; ?></td>
<td><?php echo $DR_DUE; ?></td>
