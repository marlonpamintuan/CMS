...
if(!isset($_POST['CUSTOMER_NAME']) && !isset($_POST['TRANSACTION_DATE'])){
header('location:index.php');
}else{
//START OF QUERY , FOR DISPLAYING THE CUSTOMER NAME ADDRESS AND DATE IN PRINT
  $CUSTOMER_NAMESEARCH2= $_POST['CUSTOMER_NAME'];
    $TRANSACTION_DATE = security(date('Y-m-d',strtotime($_POST['TRANSACTION_DATE'])));

$query2 = "select * from dr inner join customer ON dr.CUSTOMER_ID = customer.CUSTOMER_ID WHERE customer.CUSTOMER_NAME = '$CUSTOMER_NAMESEARCH2'";
...
function myFunction() {
    ...
    window.print();
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Per Customer List</li>
      </ol>
    </section>
...
<h4 class="font" style="font-size:15px;">AS OF <?php echo date('m/d/Y',strtotime($TRANSACTION_DATE));?></h4>
</div>
</div>
<div class="row">
<div class="col-md-12">
<h4 class="font"><?php echo $name_of_customer;?></h4>
<h4 class="font"><?php echo $address_of_customer;?></h4>
<br>
<h4 class="font" style="font-size:15px;">Gentlemen:</h4>
<h4 class="font" style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Our records show that as of this date, you have in your holding a number of containers subject of the following transactions, to wit:</h4>
<table class="table " >
<thead>
<tr>
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;" >SINCE</th>
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;">D.R. #</th>
<th class="font text-center" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;" >CONTAINER</th>
<th class="font text-center" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;">DUE</th>
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;">DAYS</th>
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;" >STATUS</th>
<th class="font" style="border-color:black; border-bottom:1px solid black;border-top:1px solid black;">REMARKS</th>
</tr>
</thead>
<?php
...
?>
<tr>
<td class="font" style="border:none!important;" ><?php echo $SINCE;?></td>
<td class="font" style="border:none!important;"><?php echo $DR_NO;?></td>
<td class="font text-center" style="border:none!important;" ><?php echo $CYLINDER_ID;?></td>
<td class="font text-center" style="border:none!important;" ><?php echo $DUE;?></td>
<td class="font" style="border:none!important;"><?php echo $DR_DAYS;?></td>
<td class="font"  style="border:none!important;"><?php echo $DR_DUE;?></td>
<td class="font" style="border:none!important;" >&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;&lowbar;</td>
</tr>
...
<h4 style="font-size: 15px!important;" class="font">We would appreciate it if you could verify the presence of these containers in your premises and return empty containers to us in the soonest possible time to avoid penalty.<br>
Thank you for your kind attention.</h4>
</div>
</div>
<br>
<div class="container-fluid">
...
<div class="row">
<div class="col-xs-12">
<h4 class="font" style="font-size: 15px!important;">Received: ________________</h4>
</div>
</div>
<div class="row">
<div class="col-xs-12">
<h4 class="font" style="font-size: 15px!important;">&nbsp;&nbsp;&nbsp;&nbsp;Date: ________________</h4>
</div>
</div>
</div>
<div class="col-xs-6" >
<div class="row">
<div class="col-xs-12">
<h4 class="font" style="font-size: 15px!important;">Certified Correct:<br><br> ________________________________</h4>
</div>
</div>
</div>
</div>
