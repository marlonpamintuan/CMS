...
if(empty($_REQUEST['id'])){
	?><script>window.location="../container_list/";</script><?php
	
}
if(isset($_REQUEST['id'])){
	$fetch = mysqli_query($link,"select * from cylinder where CYLINDER_ID=".$_REQUEST['id']);
	if(mysqli_num_rows($fetch)>0){
		$catch = mysqli_fetch_array($fetch);
		$CYLINDER_REFERENCEID = $catch['CYLINDER_REFERENCEID'];
$CYLINDER_DETAILS = $catch['CYLINDER_DETAILS'];
$CYLINDER_TYPE = $catch['CYLINDER_TYPE'];

	}else{
			?><script>alert("sorry, but we dont have that id.");window.location="../container_list/";</script><?php
...
<head>
  ...
  <title>CMS | Edit Container</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-warning color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-flask text-warning"></i><i class="fa fa-edit text-warning"></i>&nbsp;Edit Container</h3>
			  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<div id="result"></div>
		<form method="post" id="edit_formcylinder" action="">
             <div class="row">
			 <div class="col-md-6">
						<label class="control-label">Container Serial Number<span class="text-primary">*</span></label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="fa fa-user"></i>
							</div>
							
								<input type="text" name="CYLINDER_REFERENCEID" value="<?php echo $CYLINDER_REFERENCEID;?>" id="CYLINDER_REFERENCEID"  class="form-control" required>
							<input type="hidden" name="CYLINDER_ID" value="<?php echo $ID;?>">
          ...
          <div class="col-md-6">
            ...
            <option value="<?php echo $CYLINDER_TYPE;?>"><?php echo $CYLINDER_TYPE;?></option>
           
            <?php
            $select_container = mysqli_query($link,"select * from container where CONTAINER_TYPE != '$CYLINDER_TYPE'");
					...
					<div class="col-md-12">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="text" name="CYLINDER_DETAILS" value="<?php echo $CYLINDER_DETAILS;?>" id="CYLINDER_DETAILS"  class="form-control" >
