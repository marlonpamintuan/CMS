...
if(isset($_REQUEST['delete_id']))
{
 ...
 $sql_query="delete from trash WHERE CYLINDER_ID=".$_REQUEST['delete_id'];
 $delete = mysqli_query($link,$sql_query);
 if($delete){
  $info = "Deleted container:";
  $audit_query = mysqli_query($link,"insert into audittrail(AUDITTRAIL_ACTIVITY,AUDITTRAIL_ACTION,AUDITTRAIL_INFO,AUDITTRAIL_DATE,AUDITTRAIL_DATEONLY,AUDITTRAIL_USER) VALUES('Retrieve Module','Deleted Container','$info $delete_id','$TRASH_DATEDELETED','$DATEONLY','$userid')");
  if($audit_query){
...
if(isset($_REQUEST['recover_id']))
{
 ...
 if($result){
$delete_throw = mysqli_query($link,"update trash set TRASH_STATUS='inactive' where CYLINDER_ID=".$_REQUEST['recover_id']);
if($delete_throw){
$info = "Retrieved:";
  $audit_query = mysqli_query($link,"insert into audittrail(AUDITTRAIL_ACTIVITY,AUDITTRAIL_ACTION,AUDITTRAIL_INFO,AUDITTRAIL_DATE,AUDITTRAIL_DATEONLY,AUDITTRAIL_USER) VALUES('Retrieve Module','Retrieve Container','$info $recover','$CYLINDER_DATERECOVER','$DATEONLY','$userid')");
  if($audit_query){
...
<head>
  ...
  <title>CMS | List of Container Under Maintenance </title>
  <!-- Tell the browser to be responsive to screen width -->  <link rel="icon" href="../../login/logo2.jpg">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Select Container To Retrieve</label>
                  <?php $query = "select * from trash where TRASH_STATUS = ''";
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-warning color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-trash-o text-warning">&nbsp;</i>Throw List</h3>
         ...
         <th class="bg-primary"></th>
          ...
          <th  class="bg-primary">REASON</th>
                ...
                <tbody>
                        <?php
$query = "select * from trash where TRASH_STATUS =''";
...
$TRASH_DATECREATED = $row['TRASH_DATECREATED'];
$TRASH_DATEMODIFIED = $row['TRASH_DATEMODIFIED'];
?>
   <tr>
...
<td><?php echo $TRASH_REASON; ?></td>
<td><?php echo $TRASH_DATECREATED; ?></td>
<td><?php echo $TRASH_DATEMODIFIED; ?></td>
              </tr>
<?php
}
...
swal({
    ...
    function(isConfirm) {
       ...
       window.location.href='../throw_edit/index.php?id='+id;
