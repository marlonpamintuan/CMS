...
if(empty($_REQUEST['id'])){
	?><script>window.location="../throw_list/";</script><?php
	
}
if(isset($_REQUEST['id'])){
	$fetch = mysqli_query($link,"select * from trash where CYLINDER_ID=".$_REQUEST['id']);
	if(mysqli_num_rows($fetch)>0){
		$catch = mysqli_fetch_array($fetch);
$TRASH_ID = $_REQUEST['id'];
$TRASH_REASON = $catch['TRASH_REASON'];

	}else{
			?><script>alert("sorry, but we dont have that id.");window.location="../throw_list/";</script><?php
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-warning color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-edit text-warning"></i>&nbsp;Edit Reason</h3>
			  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<div id="result"></div>
		<form method="post" id="edit_trash" action="">
          <div class="row">
					<div class="col-md-12">
						<label class="control-label">Reason to Throw</label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="fa fa-envelope-o"></i>
							</div>
							
								<input type="text" name="TRASH_REASON" value="<?php echo $TRASH_REASON;?>" id="TRASH_REASON"  class="form-control" >
						  <input type="hidden" name="TRASH_ID" value="<?php echo $TRASH_ID;?>" id="TRASH_ID"  class="form-control" >
			 ...
			 <input type="submit" name="TRASH_SUBMIT" class="btn btn-warning btn-flat pull-right"/>
			 </form>
