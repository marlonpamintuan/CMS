...
<head>
  ...
  <title>CMS | Inward Receipt</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Inward Receipt</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <h3 class="box-title"><i class="fa fa-plus text-danger">&nbsp;</i>Add Inward Receipt</h3>
        ...
        <div class="box-body">
        <div id="result"></div>
    <form method="post" id="add_formir" action="">
        ...
        <div class="col-md-6">
           <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="number" min="0" name="IR_NO"  class="form-control pull-right" id="IR_NO" required/>
                </div>
                <!-- /.input group -->
              </div>
        </div>
            ...
            <div class="col-md-6">
             ...
             $query = "select DISTINCT customer.*, dr.CUSTOMER_ID from customer inner join dr on customer.CUSTOMER_ID = dr.CUSTOMER_ID where dr.DR_STATUS != 'inactive'";
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="IR_RETURNDATE"  class="form-control pull-right" id="datepicker2" required />
                </div>
                <!-- /.input group -->
              </div>
            </div>
