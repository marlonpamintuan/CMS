...
if(empty($_REQUEST['IR_NO'])){
  ?><script>window.location="../../ir_edit/";</script><?php
  
}
if(!isset($_REQUEST['IR_NO'])){
   ?><script>alert("sorry, but we dont have that id.");window.location="../../ir_edit/";</script><?php
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <span class="label label-primary">IR Number : <?php echo $IR_NO2;?></span><br><br>
    <form method="post" id="add_formdr" class="add_formdr" action="">
        
                  <input type="hidden" value="<?php echo $IR_NO2;?>" min="0" name="IR_NO"  class="form-control pull-right" id="IR_NO" required/>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Add More Container <font style="color:#dd4b39;font-size: 11px;">(FORMAT: CONTAINER NO. (CUSTOMER WHO BORROWED CONTAINER))</font></label>
            ...
            <br>
       <input type="submit" id="submit" value="Submit" name="USER_SUBMIT" class="btn btn-danger btn-flat btn-md pull-right"/>
