...
if(isset($_REQUEST['IR_NO'])){
  $fetch = mysqli_query($link,"select * from ir inner join customer ON ir.CUSTOMER_ID = customer.CUSTOMER_ID where IR_NO=".$_REQUEST['IR_NO']);
  if(mysqli_num_rows($fetch)>0){
   ...
   $IR_RETURNDATE = $catch['IR_RETURNDATE'];
 $IR_NO = $catch['IR_NO'];
 
         }else{
      ?><script>alert("sorry, but we dont have that id.");window.location="../ir_list/";</script><?php
    
    
  }
  
}else{
  ?><script>window.location="../ir_list/";</script><?php
}
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Inward Receipt</a></li>
        <li class="active">Edit Inward Receipt</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <h3 class="box-title"><i class="fa fa-plus text-danger">&nbsp;</i>Edit Inward Receipt</h3>
         <a class="btn btn-primary btn-sm pull-right" href="add_more/index.php?IR_NO=<?php echo $IR_NO;?>"><span class="fa fa-plus"></span>&nbsp;<strong>Add more data to this IR number</strong></a>
    ...
    <span class="label label-primary">IR Number : <?php echo $IR_NO;?></span><br><br>
         <div class="row">
         <input type="hidden" min="0" name="IR_NO" value="<?php echo $IR_NO;?>" class="form-control pull-right" id="IR_NO" required/>
         <div class="col-md-6">
          <label>IR Number</label>
         <input type="number" min="0" name="IR_NO_ORIG" value="<?php echo $IR_NO;?>" class="form-control pull-right" id="IR_NO" required/>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="IR_RETURNDATE" value="<?php echo $IR_RETURNDATE;?>" class="form-control pull-right" id="datepicker2" required />
                </div>
                <!-- /.input group -->
              </div>
            </div>
