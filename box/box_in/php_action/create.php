...
$BOXIN_RDI = $_POST['BOXIN_RDI'];
$count = mysqli_query($link,"select BOXIN_RDI from boxin where BOXIN_RDI='$BOXIN_RDI'");
$count_result = mysqli_num_rows($count);
if($count_result > 0)
{
	$validator['success'] = false;
	$validator['messages'] = "Duplicate RDI number";	
}
else{
