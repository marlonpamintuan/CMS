  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Box</a></li>
        <li class="active">Box Out List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-list-alt text-primary">&nbsp;</i>Out Box List</h3>
      ...
      <div class="col-md-12">
        ...
        <table class="table table-striped table-hover " id="manageMemberTable">          
          <thead>
            ...
            <th class="bg-primary">GATEPASS</th>
 ...
 <div class="row">
  ...
  <div class="col-md-7"> 
      <label for="editName" class="control-label">Box Code <font style="font-size:11px;color:#b02722;">(CHOOSE BELOW IF YOU WANT TO CHANGE THE BOX CODE, IF NOT LEAVE IT BLANK)</font></label>
        ...
        $result2 = mysqli_query($link,$query);
        ?>
         <select class="form-control select2" name="BOXOUT_BOXCODE" data-placeholder="Select a Box" style="width: 100%;" id="BOXOUT_BOXCODE" required="">
  ...
  <input type="text" class="form-control" placeholder="Box Status" id="BOXOUT_BOXSTATUS" name="BOXOUT_BOXSTATUS">
  </div>
        <!-- here the text will apper  -->
  </div>
...
<br>
  ...
  <input type="number" min="0" class="form-control" placeholder="Dry Ice Weight" id="BOXOUT_DICEWEIGHT" name="BOXOUT_DICEWEIGHT">
  </div>
        <!-- here the text will apper  -->
  </div>
    <div class="col-md-5"> 
      <label for="editName" class="control-label">Box Weight</label>
        <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-slack"></i></span>
  <input type="number" class="form-control" placeholder="Box Weight" id="BOXOUT_BOXWEIGHT" name="BOXOUT_BOXWEIGHT">
  </div>
        <!-- here the text will apper  -->
  </div>
