  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Audit Trail List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-list-alt text-primary">&nbsp;</i>Activity Log</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="col-md-1">
                 <input type="submit" value="Search" class="btn btn-primary pull-right"/><br>
