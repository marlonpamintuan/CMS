...
if(empty($_REQUEST['DR_NO'])){
  ?><script>window.location="../../dr_edit/";</script><?php
  
}
if(!isset($_REQUEST['DR_NO'])){
   ?><script>alert("sorry, but we dont have that id.");window.location="../../dr_edit/";</script><?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Edit Direct Receipt</a></li>
        <li class="active">Add More Data</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <h3 class="box-title"><i class="fa fa-plus text-danger">&nbsp;</i>Add More Data</h3>
    ...
    <span class="label label-primary">DR Number : <?php echo $DR_NO2;?></span><br><br>
    <form method="post" id="add_formdr" class="add_formdr" action="">
        
                  <input type="hidden" value="<?php echo $DR_NO2;?>" min="0" name="DR_NO"  class="form-control pull-right" id="DR_NO" required/>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Add More Container</label>
                <?php $querys = "select * from cylinder where CYLINDER_STATUS =''";
...
<input type="checkbox" id="check" onchange="myFunction()" name="track"/>&nbsp;<strong style="font-size:9px; font-family: verdana;">CHECK THIS IF YOU WANT TO SAVE</strong>
            
            </div>
            </div>
            <br>
       <input type="submit" id="submit" value="Check History" name="USER_SUBMIT" class="btn btn-danger btn-flat btn-md pull-right"/>
...
<!--
        ...
        <input type="hidden" name="history" id="val"/><br>
        <input type="submit" class="btn btn-primary btn-flat pull-right" style="margin-top:-20px;" value="Check The Last Return"></input>
...
<script>
function myFunction() {
document.getElementById("submit").value = "Check History";
 
      if(document.getElementById("check").checked){
  document.getElementById("submit").value = "Submit Now";
  }
}
</script>
</body>
