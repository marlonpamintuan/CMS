  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Direct Receipt</a></li>
        <li class="active">Customize Direct Receipt</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <h3 class="box-title" style="color:white;"><i class="fa fa-plus text-default">&nbsp;</i>Customize Direct Receipt</h3>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="DR_TRANSACTION_DATECREATED"  class="form-control pull-right" id="datepicker0" required/>
                </div>
                <!-- /.input group -->
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                ?>
                <select class="form-control select2"  name="CUSTOMER_ID" data-placeholder="Select a Customer" style="width: 100%;" required>
...
<input type="checkbox" id="check" onchange="myFunction()" name="track"/>&nbsp;<strong style="font-size:9px; font-family: verdana;">CHECK THIS IF YOU WANT TO SAVE</strong>
            ...
            <br>
       <input type="submit" id="submit" value="Check History" name="USER_SUBMIT" class="btn btn-primary btn-flat btn-md pull-right"/>
