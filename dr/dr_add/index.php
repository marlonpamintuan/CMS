...
<br>
          ...
          <div class="pull-right">
          <button type="submit" name="send" id="btnsave" value="save" class="btn btn-primary"><strong>SAVE NEW DR</strong></button>
      <button onclick="submitForm('php_action/history.php')" title="Leave atleast one textbox empty when searching for history" id="btnhistory" class="btn btn-success"><strong>HISTORY</strong></button>
      </div><br><br>
