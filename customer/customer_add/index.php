        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-user-plus text-success">&nbsp;</i>Add Customer</h3>
			  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<div id="result"></div>
		<form method="post" id="add_formcustomer" action="">
             <div class="row">
			 <div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="text" placeholder="Customer Name" name="CUSTOMER_NAME" id="CUSTOMER_NAME"  class="form-control" required>
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="number" placeholder="Customer Contact Number" name="CUSTOMER_CONTACTNUMBER"  id="CUSTOMER_CONTACTNUMBER"  class="form-control" >
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="email" placeholder="Customer Email Address" name="CUSTOMER_EMAIL"  id="CUSTOMER_EMAIL"  class="form-control">
					...
					<div class="col-md-12">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="text" placeholder="Customer Full Address" name="CUSTOMER_ADDRESS" id="CUSTOMER_ADDRESS"   class="form-control" required>
