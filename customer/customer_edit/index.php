...
if(isset($_REQUEST['id'])){
	$fetch = mysqli_query($link,"select * from customer where CUSTOMER_ID=".$_REQUEST['id']);
	if(mysqli_num_rows($fetch)>0){
		$catch = mysqli_fetch_array($fetch);
		$CUSTOMER_NAME = $catch['CUSTOMER_NAME'];
$CUSTOMER_CONTACTNUMBER = $catch['CUSTOMER_CONTACTNUMBER'];
$CUSTOMER_EMAIL = $catch['CUSTOMER_EMAIL'];
$CUSTOMER_ADDRESS = $catch['CUSTOMER_ADDRESS'];
	}else{
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-user-plus text-primary">&nbsp;</i>Edit Customer</h3>
		...
		<form method="post" id="edit_formuser" action="">
             <div class="row">
			 <div class="col-md-4">
						<label class="control-label">Name <span class="text-primary">*</span></label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="fa fa-user"></i>
							</div>
							
								<input type="text" name="CUSTOMER_NAME" value="<?php echo $CUSTOMER_NAME;?>" id="CUSTOMER_NAME"  class="form-control" required>
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="number" name="CUSTOMER_CONTACTNUMBER" value="<?php echo $CUSTOMER_CONTACTNUMBER;?>" id="CUSTOMER_CONTACTNUMBER"  class="form-control" >
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="email" name="CUSTOMER_EMAIL" value="<?php echo $CUSTOMER_EMAIL;?>" id="CUSTOMER_EMAIL"  class="form-control">
			 ...
			 <div class="row">
					...
					<div class="col-md-12">
						<label class="control-label">Address <span class="text-primary">*</span></label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="fa fa-map-marker"></i>
							</div>
							
								<input type="text" name="CUSTOMER_ADDRESS" id="CUSTOMER_ADDRESS" value="<?php echo $CUSTOMER_ADDRESS;?>"  class="form-control" required>
			 ...
			 <input type="submit" name="CUSTOMER_SUBMIT" class="btn btn-success btn-flat pull-right"/>
			 </form>
