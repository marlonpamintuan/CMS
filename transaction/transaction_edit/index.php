...
if(empty($_REQUEST['id'])){
  ?><script>window.location="../transaction_list/";</script><?php
  
}
if(isset($_REQUEST['id'])){
  $fetch = mysqli_query($link,"select * from transaction inner join customer ON transaction.CUSTOMER_ID = customer.CUSTOMER_ID where TRANSACTION_ID=".$_REQUEST['id']);
  if(mysqli_num_rows($fetch)>0){
    $catch = mysqli_fetch_array($fetch);
    $CUSTOMER_NAME = $catch['CUSTOMER_NAME'];
      $CUSTOMER_ID = $catch['CUSTOMER_ID'];
    $CYLINDER_ID = $catch['CYLINDER_ID'];
  $TRANSACTION_DRDATE = $catch['TRANSACTION_DRDATE'];
   $TRANSACTION_DUEDATE = $catch['TRANSACTION_DUEDATE'];
      $TRANSACTION_IRDATE = $catch['TRANSACTION_IRDATE'];
         $TRANSACTION_DAYS = $catch['TRANSACTION_DAYS'];
          $TRANSACTION_ID = $_REQUEST['id'];
  }else{
      ?><script>alert("sorry, but we dont have that id.");window.location="../user_list/";</script><?php
    
    
  }
  
}else{
  ?><script>window.location="../user_list/";</script><?php
}
...
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h3 class="box-title"><i class="fa fa-plus text-danger">&nbsp;</i>Edit Transaction</h3>
    ...
    <form method="post" id="edit_transac" class="add_formdr" action="">
        
          <div class="row">
          <div class="col-md-6">
        <div class="form-group">
                <label>Select IR Number</label>
                  <?php $query = "select DISTINCT(TRANSACTION_IRNO) from transaction where TRANSACTION_STATUS =''";
                $result3 = mysqli_query($link,$query);
                ?>
                <select class="form-control select2"  name="TRANSACTION_IRNO" data-placeholder="Select IR Number" style="width: 100%;" required="">
                  <?php while($row3 = mysqli_fetch_array($result3)){
              $TRANSACTION_IRNO = $row3['TRANSACTION_IRNO'];
                ?> <option value="<?php echo $TRANSACTION_IRNO;?>"><?php echo $TRANSACTION_IRNO;?></option><?php
                }?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Select Customer</label>
                  <?php $query = "select * from customer where CUSTOMER_STATUS != 'inactive' AND CUSTOMER_NAME!='$CUSTOMER_NAME'";
                $result2 = mysqli_query($link,$query);
                ?>
                <select class="form-control select2"  name="CUSTOMER_IDS" data-placeholder="Select a Customer" style="width: 100%;" required="">
                 <option value="<?php echo $CUSTOMER_ID?>" ><?php echo $CUSTOMER_NAME; ?></option>
                  <?php while($row2 = mysqli_fetch_array($result2)){
              $CUSTOMER_NAMES = $row2['CUSTOMER_NAME'];
               $CUSTOMER_ID = $row2['CUSTOMER_ID'];
                ?> <option value="<?php echo $CUSTOMER_ID;?>"><?php echo $CUSTOMER_NAMES;?></option><?php
                }?>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <?php $querys = "select * from cylinder where CYLINDER_STATUS != 'inactive' and CYLINDER_REFERENCEID != '$CYLINDER_ID' ";
                $result = mysqli_query($link,$querys);
                ?>
                <select class="form-control select2" id="cylinder" onchange="myFunction()" data-placeholder="Select a Cylinder" name="CYLINDER_REFERENCEIDS" style="width: 100%;" required>
                <option value="<?php echo $CYLINDER_ID?>" ><?php echo $CYLINDER_ID; ?></option>
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="TRANSACTION_DRDATE" value="<?php echo $TRANSACTION_DRDATE;?>" class="form-control pull-right" id="datepicker" required/>
                </div>
                <!-- /.input group -->
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="TRANSACTION_DUEDATE" value="<?php echo $TRANSACTION_DUEDATE;?>" class="form-control pull-right" id="datepicker2" required />
                </div>
                <!-- /.input group -->
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="TRANSACTION_IRDATE" value="<?php echo $TRANSACTION_IRDATE;?>" class="form-control pull-right" id="datepicker3" required />
                </div>
                <!-- /.input group -->
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="number" name="TRANSACTION_DAYS" value="<?php echo $TRANSACTION_DAYS;?>" class="form-control pull-right" id="datepicker2" required />
       ...
       <input type="submit" name="USER_SUBMIT" class="btn btn-danger btn-flat pull-right"/>
       </form>
