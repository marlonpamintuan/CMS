...
<head>
  ...
  <title>CMS | List of Transactions</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-flask text-success">&nbsp;</i>Transaction History by Customers</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="row">
            ...
            <form method="post" action="print.php">
              <div class="form-group">
                ...
                <select class="form-control select2"  name="CUSTOMER_CYLINDER" data-placeholder="Select a Customer" style="width: 100%;" required/>
...
<td><?php echo $TRANSACTION_DRNO; ?></td>
<td><?php echo $TRANSACTION_IRNO; ?></td>
<td><?php echo $CUSTOMER_NAME2; ?></td>
<td><?php echo $CYLINDER_ID; ?></td>
<td><?php echo $TRANSACTION_DRDATE; ?></td>
<td><?php echo $TRANSACTION_DUEDATE; ?></td>
<td><?php echo $TRANSACTION_IRDATE; ?></td>
<td class="text-center"><?php echo $DAYS -> format("%a"); ?></td>
              </tr>
<?php
}
...
swal({
  ...
  window.location.href='../transaction_edit/index.php?id='+id;
