...
if(isset($_REQUEST['id'])){
	$fetch = mysqli_query($link,"select * from user where USER_ID=".$_REQUEST['id']);
	if(mysqli_num_rows($fetch)>0){
		$catch = mysqli_fetch_array($fetch);
		$USER_FIRSTNAME = $catch['USER_FIRSTNAME'];
$USER_MIDDLENAME = $catch['USER_MIDDLENAME'];
$USER_LASTNAME = $catch['USER_LASTNAME'];
$USER_EMAIL = $catch['USER_EMAIL'];
$USER_USERNAME = $catch['USER_USERNAME'];
$USER_PASSWORD = $catch['USER_PASSWORD'];
$USER_ACCESS = $catch['USER_ACCESS'];
$USER_AUDIT = $catch['USER_AUDIT'];
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-user-plus text-primary">&nbsp;</i>Edit User</h3>
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="text" name="USER_MIDDLENAME" value="<?php echo $USER_MIDDLENAME;?>" id="USER_MIDDLENAME"  class="form-control" >
					...
					<div class="col-md-8">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="email" name="USER_EMAIL" id="USER_CONTACTNUMBER" value="<?php echo $USER_EMAIL;?>"  class="form-control">
						
							
						</div>
					</div>
          <div class="col-md-4">
            <label class="control-label">User Access <span class="text-primary">*</span></label>
            <div class="input-group">
              <div class="input-group-addon">
                <i class="fa fa-user"></i>
              </div>
               ...
               <option label="-- Select User Access --"></option>
               <?php if($USER_ACCESS === 'super admin'){
                ?>
			 ...
			 <div class="col-md-4">
					 ...
					 <div class="col-md-4">
						<label class="control-label">Password <span class="text-primary">*</span></label>
						<div class="input-group">
							<div class="input-group-addon">
					 ...
					 <div class="col-md-4">
						<label class="control-label">Re-enter Password <span class="text-primary">*</span></label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="fa fa-lock"></i>
							</div>
							
								<input type="password" name="USER_REPASSWORD" id="USER_REPASSWORD"  class="form-control" required>
       ...
       <?php if($USER_AUDIT == '1'){
        ?>
        <input type="checkbox" name="USER_AUDIT" value="1" checked></input>&nbsp;Check this if you want this user to view audit trail
        <?php
        }else{
          ?>
          <input type="checkbox" name="USER_AUDIT" value="1"></input>&nbsp;Check this if you want this user to view audit trail
       <?php
          }?>
       </div>
       </div>
