...
if(isset($_REQUEST['delete_id']))
{
  ...
  $audit_query = mysqli_query($link,"insert into audittrail(AUDITTRAIL_ACTIVITY,AUDITTRAIL_ACTION,AUDITTRAIL_INFO,AUDITTRAIL_DATE,AUDITTRAIL_DATEONLY,AUDITTRAIL_USER) VALUES('User Module','Deleted user','$info $user','$USER_DATEDELETED','$DATEONLY','$userid')");
if($audit_query){
  $sql_query="Update user set USER_STATUS='inactive',USER_DATEDELETED='$USER_DATEDELETED' WHERE USER_ID=".$_REQUEST['delete_id'];
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border ">
      	   <h3 class="box-title"><i class="fa fa-list-alt text-primary">&nbsp;</i>User List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
         ...
         <th class="bg-primary"></th>
          ...
          <th class="bg-primary">ACCESS</th>
                ...
                <tbody>
                        <?php
$query = "select * from user where USER_STATUS !='inactive'";
...
<td class="text-center"><div class="dropdown">
    ...
    <ul class="dropdown-menu">
     <li class=""><a   href="javascript:edit_id('<?php echo $USER_ID; ?>')" title="Edit Slider Info" ><span class="fa fa-edit"></span>&nbsp;Edit</a></li>
     <li class=""><a  href="javascript:delete_id('<?php echo $USER_ID; ?>')" title="Inactive Item"><span class="fa fa-trash-o"></span>&nbsp;Delete</a></li>
  </ul>
</div></td>
<td><?php echo $USER_FIRSTNAME; ?></td>
<td><?php echo $USER_MIDDLENAME; ?></td>
...
swal({
  ...
  window.location.href='../user_edit/index.php?id='+id;
