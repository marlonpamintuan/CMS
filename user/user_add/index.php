        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-user-plus text-primary">&nbsp;</i>Add User</h3>
			  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<div id="result"></div>
		<form method="post" id="add_formuser" action="">
             <div class="row">
			 <div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="text" placeholder="Middle Name" name="USER_MIDDLENAME"  id="USER_MIDDLENAME"  class="form-control" >
					...
					<div class="col-md-8">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="email" placeholder="Email Address" name="USER_EMAIL" id="USER_EMAIL"   class="form-control">
			 ...
			 <div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="text" placeholder="Username" name="USER_USERNAME" id="USER_USERNAME"  class="form-control" required>
					 ...
					 <div class="col-md-4">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="password" placeholder="Re-enter password" name="USER_REPASSWORD" id="USER_REPASSWORD"  class="form-control" required>
...
function reloadChat () {
          ...
          $('#transac').load('../../php/transac.php');
          $('#transac2').load('../../php/transac2.php');
