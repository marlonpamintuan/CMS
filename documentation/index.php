   ...
   <li class="dropdown messages-menu">
          ...
          <li class="notifications-menu active" style="border-right:2px solid #3c8dbc;">
            <a href="../throw/throw_list/">
              <i class="fa fa-trash"></i>&nbsp;&nbsp;<strong>CONTAINER BIN</strong>
...
<?php
        ...
        <li class="" title="Direct Receipt">
          <a href="../dr/dr_list">
            <i class="fa fa-flask"></i> <span>Direct Receipt</span>
                <span class="pull-right-container">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-info-circle text-primary"></i>&nbsp;Documentation</h3>
			  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			  
             <h3>First Click this icon "Xampp"</h3>
             <div class="well" style="background: none;">
             <img src="../dist/img/xampp.png" style="width:15%;"/>
             </div>
             <div class="row">
             <div class="col-md-6">
            <h3> After you click you will now see this window</h3>
              <img src="../dist/img/xampp_start.png" style="width:100%;"/>
             </div>
               <div class="col-md-6">
             <h3>Press Start to Apache and MySQL </h3>
             <img src="../dist/img/xampp_check.png" style="width:100%;"/>
             </div>
             </div>
        
                <div class="row">
                <div class="col-md-12">
             <h3> Now, click on your google chrome browser</h3>
                </div>
                </div>
                    <div class="row">
                <div class="col-md-12">
             <img src="../images/home.png" style="width:100%;"/>
                   ...
                   <div class="row">
                <div class="col-md-12">
                 <h3> You can now use the system</h3>
             <img src="../images/dashboard.png" style="width:100%;"/>
                </div>
                </div>
                <hr style="border-top:5px solid #337ab7;">
            <h3>Now, If you want to open the system simultaneously in another PC, just follow the instructions below. Please make sure that you are connected in the same network. Example you are connected on the same WI-FI or LAN</h3><br>
            <h3>First Step,  Click Window icon below</h3>
            <div class="row">
<div class="col-md-12">
  <img src="../dist/img/window.png" style="width:100%;"/>
</div>
            </div>
                <h3>Second Step,  Type CMD and press enter</h3>
            <div class="row">
<div class="col-md-12">
  <img src="../dist/img/cmd.png" style="width:100%;"/>
</div>
            </div>
            <h3>Third Step,  Type ipconfig and press enter</h3>
            <div class="row">
<div class="col-md-12">
  <img src="../dist/img/cmd_start.png" style="width:100%;"/>
</div>
            </div>
                <h3>Fourth Step,  Copy the "IPV4" Ip address and paste into your google chrome browser</h3>
            <div class="row">
<div class="col-md-12">
  <img src="../dist/img/cmd_ipshow.png" style="width:100%;"/>
</div>
            </div>
               <div class="row">
<div class="col-md-12">
  <img src="../images/dashboard2.png" style="width:100%;"/>
</div>
            </div>
            </div>
