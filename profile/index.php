...
$select = mysqli_query($link,"select * from user where USER_ID = '$userid'");
$fetch = mysqli_fetch_array($select);
$USER_FIRSTNAME = $fetch['USER_FIRSTNAME'];
$USER_MIDDLENAME = $fetch['USER_MIDDLENAME'];
$USER_LASTNAME = $fetch['USER_LASTNAME'];
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="row">
      <div class="col-md-12">
       <input type="submit" class="btn btn-primary btn-flat pull-right"/>
      </div>
      </div>
      </form>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-user text-primary">&nbsp;</i>Edit Profile</h3>
			  <h6 class="box-title pull-right"><a class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#myModal"><span class="fa fa-lock"></span>&nbsp;Change Password</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<div id="result"></div>
					...
					<div class="col-md-8">
						...
						<div class="input-group">
							<div class="input-group-addon">
								...
								<input type="email" name="USER_EMAIL" id="USER_CONTACTNUMBER" value="<?php echo $USER_EMAIL;?>"  class="form-control" required>
            ...
            <div class="input-group">
              <div class="input-group-addon">
                ...
                <input type="text" name="USER_USERNAME" value="<?php echo $USER_USERNAME;?>" id="USER_USERNAME"  class="form-control" required>
					...
					<div class="col-md-4">
						<input type="hidden" value="admin" name="USER_ACCESS"/>
					</div>
			 </div>
...
<!-- page script -->
	...
	<script>
	var password = document.getElementById("USER_NEWPASSWORD")
